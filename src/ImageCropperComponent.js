...
var ImageCropperComponent = (function () {
    function ImageCropperComponent() {
        ...
        this.rotation = 0;
        this.pinch = Observable.create(function (observer) {
            _this.pinchObserver = observer;
        });
        this.pan = Observable.create(function (observer) {
...
], ImageCropperComponent.prototype, "gridAlpha", void 0);
__decorate([
    Input(),
    __metadata("design:type", Boolean)
], ImageCropperComponent.prototype, "showGrid", void 0);
